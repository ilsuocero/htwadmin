...
export const useEditModeManager = () => {
  ...
  const [pendingModeSetup, setPendingModeSetup] = useState(null);
  ...
  }, [layersAvailable, pendingModeSetup]);
  ...
  useEffect(() => {
    ...
    console.log('🎯🎯🎯🎯🎯🎯 EDIT MODE MANAGER: Setting pending mode setup to:', currentMode);
    setPendingModeSetup(currentMode);
  ...
  useEffect(() => {
    ...
    if (pendingModeSetup && allLayersAvailable) {
      console.log('🎯🎯🎯🎯🎯 EDIT MODE MANAGER: Coordinated setup - Mode:', pendingModeSetup, 'Layers available:', allLayersAvailable);
      console.log('🎯🎯🎯🎯🎯 EDIT MODE MANAGER: Setting up event handlers for mode:', pendingModeSetup);
      
      // Set up event handlers for the pending mode
      setupEventHandlers(pendingModeSetup);
      ...
      console.log('🎯🎯🎯🎯🎯 EDIT MODE MANAGER: Waiting for layers to become available for mode:', pendingModeSetup);
      console.log('🎯🎯🎯🎯🎯 EDIT MODE MANAGER: Current layer availability:', layersAvailable);
    }
  }, [pendingModeSetup, layersAvailable, setupEventHandlers]);
