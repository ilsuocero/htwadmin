...
export const useSimpleMapBehavior = (mapRef, currentMode) => {
  ...
  React.useEffect(() => {
    console.log('🚀🚀🚀 SIMPLE: ESC key handler setup - currentMode:', currentMode);
    
    const handleKeyDown = (e) => {
      console.log('🚀🚀🚀 SIMPLE: Key pressed:', e.key, 'currentMode:', currentMode);
  ...
  React.useEffect(() => {
    console.log('🚀🚀🚀 SIMPLE: Mode change useEffect triggered - currentMode:', currentMode);
    
    if (currentMode === 'EDIT') {
      console.log('🚀🚀🚀 SIMPLE: ENTERING EDIT MODE - RESETTING STATE');
      console.log('🚀🚀🚀 SIMPLE: Before reset - tempPoints:', tempPointsRef.current.length, 'isFirstClick:', isFirstClickRef.current);
      
      tempPointsRef.current = [];
      isFirstClickRef.current = true;
      
      console.log('🚀🚀🚀 SIMPLE: After reset - tempPoints:', tempPointsRef.current.length, 'isFirstClick:', isFirstClickRef.current);
      
      const map = mapRef.current?.getMap();
      if (map) {
        console.log('🚀🚀🚀 SIMPLE: Map available, initializing temporary sources');
        initializeTemporarySources(map);
        map.getCanvas().style.cursor = 'crosshair';
        console.log('🚀🚀🚀 SIMPLE: Cursor set to crosshair');
      } else {
        console.log('🚀🚀🚀 SIMPLE: Map not available for initialization');
      }
    } else {
      console.log('🚀🚀🚀 SIMPLE: Not entering edit mode, currentMode:', currentMode);
    }
