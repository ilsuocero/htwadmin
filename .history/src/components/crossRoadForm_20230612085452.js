...
export const useCrossRoadForm = (showForm,
    ...
    nameInput.addEventListener('change', (e) => {
        if (typeInput.value === 'POI') {
            ...
            longDescriptionInput.value = descriptions.primary.short;
            shortDescriptionInput2.value = descriptions.primary.short;
            longDescriptionInput2.value = descriptions.primary.short;
