...
export const usePathsForm = (editMode, setEditMODE,
    ...
    useEffect(() => {
        ...
        // Create dropdown options
        const condizioneOptions = ['Option 1', 'Option 2', 'Option 3']; // Add your desired options here
        ...
        // Get the first three coordinates and calculate the angle
        ...
        v1AngleInput.value = v1Angle.toFixed(0);

        // Get the last three coordinates in reverse order and calculate the angle
        ...
        v2AngleInput.value = v2Angle.toFixed(2);
