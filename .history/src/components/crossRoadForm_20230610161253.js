...
export const useCrossRoadForm = (showForm,
    ...
    useEffect(() => {
            ...
            try {
                ...
                if (socket) {
                    ...
                    socket.on('crossRoadSaved', (err) => {
                        if (!err) {
                            if (sF.properties.Tipo ) POI.current = true;
                            ...
                            if (POI.current) navigate('/POIedit'); // Navigate to the "POIedit" page
                        } else {
        ...
        submitButton.addEventListener('click', (e) => {
            ...
            // save into database
            if (connectionState) {
                if (typeInput.value == 'POI') POI.current = true;
                saveCrossRoad(newFeature, selectedFeature.current);
            }
            //
