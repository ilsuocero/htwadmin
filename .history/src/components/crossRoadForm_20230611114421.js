...
export const useCrossRoadForm = (showForm,
    ...
    useEffect(() => {
        ...
        shortDescriptionLabel.textContent = 'Short Description:';
        ...
        const shortDescriptionLabelIt = document.createElement('label');
        shortDescriptionLabelIt.textContent = 'Descrizione breve (Italiano):';
        shortDescriptionLabelIt.style.display = 'none';  // Initially hidden
        shortDescriptionLabelIt.style.marginBottom = '4px';

        const shortDescriptionInputIt = document.createElement('textarea');
        shortDescriptionInputIt.name = 'DescBreveIt';
        shortDescriptionInputIt.style.width = '100%';
        shortDescriptionInputIt.style.marginLeft = '4px';
        shortDescriptionInputIt.style.display = 'none';  // Initially hidden
        ...
        const longDescriptionInputIt = document.createElement('textarea');
        longDescriptionInputIt.name = 'DescEstesaIt';
        longDescriptionInputIt.style.width = '100%';
        longDescriptionInputIt.style.height = '100px';
        longDescriptionInputIt.style.marginLeft = '4px';
        ...
        submitButton.addEventListener('click', (e) => {
            ...
            if (typeInput.value === 'POI') {
                ...
                if (shortDescriptionInputIt.value.length < 30) {
                    alert('Italian short description must be at least 30 characters long.');
                    return;
                }
                if (longDescriptionInputIt.value.length < 100) {
            ...
            const newFeature = {
                ...
                properties: {
                    ...
                    id: idInput.value,
                    languageL1: 'en',
                    DescBreveL1: shortDescriptionInput.value,
                    DescEstesaL1: longDescriptionInput.value,
                    languageL2: 'en',
                    DescBrevel2: shortDescriptionInputIt.value,
                    DescEstesaIT: longDescriptionInputIt.value
                },
                geometry: {
                    type: 'Point',
                    coordinates: [lng, lat]
        ...
        crossRoadForm.appendChild(shortDescriptionLabelIt);
        crossRoadForm.appendChild(shortDescriptionInputIt);
        crossRoadForm.appendChild(longDescriptionLabelIt);
        crossRoadForm.appendChild(longDescriptionInputIt);
        ...
        // Handle changes to the 'Tipo' field
        typeInput.addEventListener('change', (e) => {
            if (e.target.value === 'POI') {
                ...
                shortDescriptionLabelIt.style.display = 'block';
                shortDescriptionInputIt.style.display = 'block';
                longDescriptionLabelIt.style.display = 'block';
                longDescriptionInputIt.style.display = 'block';
            } else {
                ...
                shortDescriptionLabelIt.style.display = 'none';
                shortDescriptionInputIt.style.display = 'none';
                longDescriptionLabelIt.style.display = 'none';
                longDescriptionInputIt.style.display = 'none';
            }
        });
