...
const Map = forwardRef(({
    ...
    const startAutoSegmentMode = () => {
        ...
        // Add click listener for destinazioni (treat as crossroads)
    ...
    const updateCrossroadSelectionColors = () => {
        if (!map.current || !map.current.getLayer('incroci')) return;
    ...
    const handleCrossroadClick = useCallback((e) => {
        ...
        const isAlreadySelected = selectedCrossroads.some(
        ...
        const newSelectedCrossroads = [...selectedCrossroads, feature];
        setSelectedCrossroads(newSelectedCrossroads);
        
        // Update visual feedback for selected crossroads
        updateCrossroadSelectionColors();
        
        console.log('🚀 Map-->[handleCrossroadClick]: Selected crossroads:', newSelectedCrossroads.length);
    ...
    }, [autoSegmentMode, selectedCrossroads, updateCrossroadSelectionColors]);
    ...
    useEffect(() => {
        if (mapLoaded && crossRoads != null) {
            ...
            if (!map.current.getSource('incroci')) {
                ...
                // Add click listener for auto-segment mode
