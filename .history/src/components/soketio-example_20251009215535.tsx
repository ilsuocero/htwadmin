    React.useEffect(() => {
        ...
        if (connectionState && connectionState.isOnline && isConnected) {
            ...
            const cleanupListener = socketOperations.on('#listenerName', (data) => {
                console.log('#NameFuntion-->[printCrossRoads]: Received crossroads data, features count:', data?.length || 0);
                var crossroads =
                {
            ...
            socketOperations.emit('#listenerName');
