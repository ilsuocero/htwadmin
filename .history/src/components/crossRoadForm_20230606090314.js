...
submitButton.addEventListener('click', (e) => {
    ...
    // Create a new feature object with the original coordinates
    const newFeature = {
        type: 'Feature',
        properties: {
            Tipo: selectedFeature.current.properties.Tipo,
            GeoFence: selectedFeature.current.properties.GeoFence,
            Nome: selectedFeature.current.properties.Nome,
            IDF: selectedFeature.current.properties.IDF,
            id: selectedFeature.current.properties.id,
        },
        geometry: {
            type: 'Point',
