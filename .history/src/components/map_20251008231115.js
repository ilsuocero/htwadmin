...
export default function Map({
    ...
    useCrossRoadForm(showForm, setShowForm, setCrossRoads,
        setDestNetwork, map, mapContainer, connectionState,
        selectedFeature, // Pass the selectedFeature.current
    );
    usePathsForm(editMode, setEditMODE, pathForm, setPathForm,
        setPathNetwork, map, mapContainer, connectionState,
        selectedFeature, // Pass the selectedFeature.current
        );
