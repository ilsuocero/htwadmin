...
export const usePathsForm = (editMode, setEditMODE,
    ...
    useEffect(() => {
        ...
        console.log('RV-->[usePathsForm]: snap1', pathForm.snap1);
        const savePath = async (newFeature) => {
            console.log('RV-->[savePath]: newFeature', newFeature);
            /*      try {
        ...
        submitButton.addEventListener('click', (e) => {
            ...
            const newSegment = {
                ...
                properties: {
                    ...
                    'V1 Angle': v1Angle,
                    'V2 Angle': v2Angle,
                    v1: pathForm.snap1.current?.featureId,
                    v2: pathForm.snap2.current?.featureId,
                },
            };
            ...
            if (connectionState) savePath(newSegment);
        ...
        cancelButton.addEventListener('click', () => {
            ...
            setEditMODE(true)
            setPathForm({ show: false, coordinates: null, sanp1: null, snap2: null });
