...
export const usePathsForm = (pathForm, setPathForm, setPathNetwork, map, mapContainer) => {
    useEffect(() => {
        // Your code here
        if (!pathForm.show) {
        ...
        const tipoOptions = ['bivio', 'destinazione', 'incrocio', 'POI'];
        ...
        submitButton.addEventListener('click', (e) => {
            ...
            const newFeature = {
                ...
                geometry: {
                    type: 'Point',
                    coordinates: [pathForm.coordinates.lng, pathForm.coordinates.lat]
                }
            };

            // Add the new feature to the crossRoads state
            setPathNetwork(prevCrossRoads => ({
                ...prevCrossRoads,
