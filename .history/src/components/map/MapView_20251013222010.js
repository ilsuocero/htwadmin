...
// 
  ...
  useEffect(() => {
    ...
    console.log('🎯MapView: Available layers:', {
      sentieri: !!map.current.getSource('sentieri'),
      destinazioni: !!map.current.getSource('destinazioni'),
      incroci: !!map.current.getSource('incroci')
    });
  ...
  }, [mapLoaded, currentMode, clearAllMapListeners, setupNormalModeHandlers, setupEditModeHandlers, setupAutoSegmentHandlers, onContextMenu]);
