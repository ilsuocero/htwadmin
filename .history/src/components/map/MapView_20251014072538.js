  ...
  const setupNormalModeHandlers = useCallback(() => {
    ...
    try {
      ...
      map.current.on('contextmenu', (e) => {
        ...
        const pos = map.current.project(e).add(new maplibregl.Point(offsetX, offsetY));

        if (onContextMenu) onContextMenu(pos);
      });
      ...
      if (map.current.getSource('sentieri')) {
        ...
        map.current.on('click', 'sentieri', (e) => {
          console.log('🎯MapView: click onr sentieri:', currentMode);
