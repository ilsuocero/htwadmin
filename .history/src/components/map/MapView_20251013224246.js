...
// 
  ...
  useEffect(() => {
    ...
    // Clear existing global handlers before registering new ones
    map.current.off('click'); // Clear global click
    map.current.off('contextmenu'); // Clear global context menu
