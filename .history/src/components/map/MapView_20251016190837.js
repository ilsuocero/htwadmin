...
const MapView = forwardRef(({
  ...
  if (editModeManager?.publicCurrentMode) {
    console.log(
      `[DEBUG] effectiveCurrentMode from editModeManager.publicCurrentMode:`,
      editModeManager.publicCurrentMode
    );
  } else {
    console.log(
      `[DEBUG] effectiveCurrentMode from currentMode:`,
      currentMode
    );
  }
...
// 
  ...
  // Event handler management - father state manages ALL events with proper timing
  useEffect(() => {
