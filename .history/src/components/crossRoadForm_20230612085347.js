...
export const useCrossRoadForm = (showForm,
    ...
    nameInput.addEventListener('change', (e) => {
        if (typeInput.value === 'POI') {
            shortDescriptionInput.value = description.primary.short

            longDescriptionInput.value.length < 100) 
            shortDescriptionInput2.value.length < 30) {
            longDescriptionInput2.value.length < 100) {
